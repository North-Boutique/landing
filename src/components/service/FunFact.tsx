...
const FunFact = () => (
  <div
    className={
      'tokyo_tm_facts w-full h-auto clear-both float-left px-0 pt-[100px] pb-[60px]'
    }>
        ...
        <ul className={'ml-[-40px] list-none'}>
          {funFacts.map((item) => (
            <li
              ...
              <div
                className={
                  'list_inner  w-full h-auto clear-both float-left relative border-solid border-[rgba(0,0,0,.1)] border text-center px-[20px] py-[40px]'
                }>
