      ...
      <ul className={'ml-[-40px] list-none flex flex-wrap'}>
        {services.map((service) => (
          <li className={'mb-[40px] w-1/3 pl-[40px]'} key={service.id}>
            <div
              className={
                'list_inner w-full h-auto clear-both float-left relative border-solid border-[rgba(0,0,0,.1)] border bg-white pt-[45px] pr-[30px] pb-[40px] pl-[30px] transition-all duration-300'
              }>
              <span
                className={
                  'number inline-block mb-[25px] relative w-[60px] h-[60px] leading-[60px] text-center rounded-full bg-[rgba(0,0,0,.03)] font-bold text-black font-montserrat transition-all duration-300'
                }>
              ...
              <Image
                className={
                  'popup_service_image opacity-0 invisible hidden absolute z-[-111]'
                }
                src={service.image}
                alt={'image'}
                height={600}
