  ...
  return (
    <ModalContainer nullValue={setNewsModal}>
      <div className={'image relative overflow-hidden'}>
        ...
        <div
          className={
            'main absolute inset-0 bg-no-repeat bg-cover bg-center transition-all duration-300'
          }
          data-img-url={newsModal.image}
          style={{ backgroundImage: `url(${newsModal.image})` }}
        />
        <Link className={'tokyo_tm_full_link'} href={'#'} />
      </div>
      <div
        className={
          'details w-full float-left px-[40px] pt-[30px] pb-[25px] bg-white transition-all duration-300'
        }>
        <div
          className={
            'extra flex items-center justify-between mb-[25px] relative'
          }>
          <div className={'short'}>
      ...
      <div className={'main_content w-full float-left'}>
        <div className={'descriptions w-full float-left'}>
          ...
          <div
            className={
              'quotebox w-full clear-both float-left h-auto relative pl-[70px] mb-[24px]'
            }>
