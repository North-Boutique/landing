    ...
    <ModalContainer nullValue={setPortfolioDetailsModal}>
      <div className={'popup_details'}>
        <div className={'top_image'}>
          <Image src={'assets/img/thumbs/4-2.jpg'} alt={'image'} />
          <div
            className={'main'}
            ...
            <ul className={'list-none'}>
              ...
              <li className={'w-full float-left'}>
                ...
                <ul className={'share list-none relative top-[7px]'}>
                  {portfolioDetailsModal.share.map((social: any) => (
        ...
        <div
          ...
          <ul className={'ml-[-30px] list-none'}>
            <li className={'mb-[30px] float-left w-1/2 pl-[30px]'}>
              <div
                className={
                  'list_inner w-full h-auto clear-both float-left relative'
                }>
            ...
            {portfolioDetailsModal.images.map((img: any, i: any) => (
