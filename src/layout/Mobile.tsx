...
const Mobile = () => {
  ...
  return (
    <Fragment>
      <div
        className={
          'tokyo_tm_topbar bg-white fixed top-0 left-0 right-0 h-[50px] z-[14] hidden'
        }>
        <div
          className={
            'topbar_inner w-full h-full clear-both flex items-center justify-between py-0 px-[20px]'
          }>
      ...
      <div
        ...
        <div
          className={
            'menu_list w-full h-auto clear-both float-left text-right px-[20px] pt-[100px] pb-[0px]'
          }>
